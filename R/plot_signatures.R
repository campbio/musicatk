...
#' to plot. If null, the first entry is selected. Default \code{NULL}.
#' @param result_modality The modality of the signatures to plot. Must be
#' "SBS96", "DBS78", or "IND83".
#' @param model_name The name of the \code{\linkS4class{result_model}} object
#' containing the signatures to plot.
