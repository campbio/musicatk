...
#' @examples
#' data(res)
#' name_signatures(res, model_id = "res", 
...
name_signatures <- function(musica, model_id, name_vector, modality = "SBS96",
  ...
  eval.parent(substitute(colnames(signatures(musica, result_name, modality, model_id)) <- name_vector))
  eval.parent(substitute(rownames(exposures(musica, result_name, modality, model_id)) <- name_vector))
}
