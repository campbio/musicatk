...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/import.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/import1.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/import2.png"))
```
<br> 
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/TCGA.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/upload_musica.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/create_musica.png"))
```
<br>

```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/create_musica1.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/AnnotationsTab.png"))
```
<br>

Select the musica object from the "Select object" dropdown, and upload the text file containing sample annotations. The application expects one column in the text file to contain the sample names. These sample names must match the sample names in the musica object. NA values will be used for any samples missing in the annotation file.

```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/AnnotationOptions.png"))
```
<br>

After selecting the correct delimiter, a data table will appear below to show the annotations that will be added to the musica object. If your annotation file does not contain a header, you need to deselect the "Header" radio button. Choose the column that contains the sample names from the "Sample Name Columns" dropdown and then click "Add Annotation".
<br>

```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/AnnotationTable.png"))
```
<br>

## Build Tables
The "Build Tables" tab is used to generate count tables for different mutation type schemas which can be used as input to the mutational signature discovery or prediction functions. To build the count tables, the user must select 1 of the 5 standard motifs in the "Select Count Table" dropdown.
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/TableTab.png"))
```
<br>

## Signatures and Exposures

The user has the option of discovering signatures and exposures without prior knowledge, or using predefined signatures to predict exposures. To discover signatures use the "Discover" tab. To predict signature exposures, use the "Predict" tab.
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/DiscoverTab.png"))
```
<br>

### Predict

Exposures for samples will be predicted using an existing set of signatures stored in a musica_result object.Algorithms available for prediction include a modify version of "lda", "decompTumor2Sig", and "deconstructSigs". To use the "deconstructSigs" algorithm, you will need to provide the reference genome. 

```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/PredictTab.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/PredictDropdown.png"))
```
<br>
...
### Signatures
The signature plot is a bar plot with each bar representing the probability of each type of mutation. By default, signatures are named by numbers, but an option of renaming signatures is provided if you want to name them otherwise, such as the possible etiology.
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/CompareTab.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/CompareTable.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/DATab.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/DAOptions.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/WilcoxonTable.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/heatmap.png"))
```
<br>

```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/heatmap1.png"))
```
<br>
...
```{r echo=FALSE}
include_graphics(paste0(PATH,"/image/download.png"))
```
