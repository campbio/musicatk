...
plot_exposures(res, plot_type = "bar", annotation = "Tumor_Subtypes")
plot_exposures(res, plot_type = "bar",  annotation = "Tumor_Subtypes", proportional = TRUE)
plot_exposures(res, plot_type = "violin", group_by = "annotation", annotation = "Tumor_Subtypes")
```
