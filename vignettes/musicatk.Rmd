...
lusc_maf <- system.file("testdata", "public_TCGA.LUSC.maf", package = "musicatk") 
...
res <- discover_signatures(musica, table_name = "SBS96", num_signatures = 3)

plot_exposure_bar(res, annotation = "Tumor_Subtypes")
plot_exposure_bar(res, annotation = "Tumor_Subtypes", proportional = TRUE)
plot_exposure_box(res, group_by = "annotation", annotation = "Tumor_Subtypes")
plot_exposure_box(res, plot_type = "box", group_by = "annotation", annotation = "Tumor_Subtypes")
```
