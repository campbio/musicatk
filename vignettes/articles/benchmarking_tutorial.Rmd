...
If signature discovery has already been performed and therefore predicted signatures and predicted exposures already exist, this information must be stored in a `musica_result` object using the `create_musica_result` function. Example data is used here.
...
new_benchmark <- benchmark(full_benchmark, res1, make_copy = TRUE, plot = FALSE)
...
# extract the res2 prediction before benchamrking adjustments have been made
...
res2_intermediate_prediction <- benchmark_get_prediction(res2_benchmark, "intermediate")
